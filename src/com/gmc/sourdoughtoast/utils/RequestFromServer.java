...
public class RequestFromServer extends AsyncTask<Object,Void,Transport> {
	...
	public RequestFromServer(String url){
...
//			Log.d("Ajax.Request","Header: "+k+" : "+headers.get(k));
	...
	public RequestFromServer setFormParams(String[][] stringsTable){
	...
	public RequestFromServer setFormParams(HashMap<?,?> hashmap){
		setHeader("Content-Type",CTYPE_FORM);
	...
	public RequestFromServer setJsonParams(JSONObject jsonObject){
	...
	public RequestFromServer setXmlParams(Document doc){
        try {
	...
	public RequestFromServer setContentType(String ctype){
	...
	public RequestFromServer setHeader(String key, String value){
	 ...
	 */
	public RequestFromServer accept(String contentType){
